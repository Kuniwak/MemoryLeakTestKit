...
class ReferencePathNormalizationTests: XCTestCase {
    func testNormalize() {
        typealias TestCase = (
            input: [NotNormalizedReferencePathComponent],
            expected: [ReferencePathComponent]
        )
        ...
        testCases.forEach { tuple in
            ...
            let actual = ReferencePathNormalization.normalize(input)
    ...
    func testHint() {
        typealias TestCase = (
            input: NotNormalizedReferencePathComponent,
            expected: ReferencePathNormalization.Hint
        )
        ...
        testCases.forEach {
            ...
            let actual = ReferencePathNormalization.Hint(input)
    ...
    private func difference(between a: [ReferencePathComponent], and b: [ReferencePathComponent]) -> String {
